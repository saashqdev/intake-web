...
To connect to a provider, Go to the
[**Servers**](https://demo.gointake.ca/settings/servers) page and click on the
**Add Server** button. You will be prompted to select a provider from the list
of available providers. Once you select a provider, you will need to provide the
